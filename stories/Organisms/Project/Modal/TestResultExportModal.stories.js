...
export default {
  title: "Organisms/Project/Modal/TestResultExportModal",
  components: { testResultExportModal },
  argTypes: {
...
const Template = (args, { argTypes }) => ({
  ...
  vuetify,
  components: { testResultExportModal },
  template: '<testResultExportModal v-bind="$props" @fileExport="fileExport"/>',
});
export const TestResultExportModal = Template.bind({});
TestResultExportModal.args = {
  team: {
    id: 1,
