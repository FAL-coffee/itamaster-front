import contactFormPage from "@template/Common/Contact/ContactFormPage.vue";
...
export default {
  title: "Template/Common/Contact/ContactFormPage",
  components: {
    contactFormPage,
    appHeader,
    appFooter,
...
const Template = (args, { argTypes }) => ({
  ...
  template: `
        <div>
            ...
            <contactFormPage @confirm="confirm" />
...
export const ContactFormPage = Template.bind({});
ContactFormPage.args = {
  api: false,
  notLatestData: false,
  user: {
    id: 1,
