import userRegisterPage from "@template/Common/User/UserRegisterPage.vue";
...
export default {
  title: "Template/Common/User/UserRegisterPage",
  components: {
    userRegisterPage,
    appHeader,
    appFooter,
...
const Template = (args, { argTypes }) => ({
  ...
  template: `
            <div>
                ...
                <userRegisterPage v-bind="$props" @profileSave="profileSave" />
...
export const UserRegisterPage = Template.bind({});
UserRegisterPage.args = {
  api: false,
  notLatestData: false,
  user: {
    id: 1,
