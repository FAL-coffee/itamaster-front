import signUpPage from "@template/Common/User/SignUpPage.vue";
...
export default {
  title: "Template/Common/User/SignUpPage",
  components: {
    signUpPage,
    appHeader,
    appFooter,
  ...
  argTypes: {
    ...
    signUpConfirm: { action: "signUpConfirm" },
  },
};
...
const Template = (args, { argTypes }) => ({
  ...
  template: `
        <div>
            ...
            <signUpPage @signUpConfirm="signUpConfirm" @toPrivacyPolicy="toPrivacyPolicy" @toTerms="toTerms" @toSpecifiedNotation="toSpecifiedNotation"/>
