...
export default {
  title: "Template/Common/Project/ProjectPage",
  components: {
    projectPage,
    appHeader,
    appFooter,
  ...
  template: `
            <div>
                ...
                <projectPage v-bind="$props"
                    @toCreateEnvironmentSteps="toCreateEnvironmentSteps" @toTestEnvironment="toTestEnvironment" @fileExport="fileExport"
                        @toRepository="toRepository" @projectEditSave="projectEditSave" @projectDestroy="projectDestroy"  
                            @testSuiteSave="testSuiteSave" @testSuiteDestroy="testSuiteDestroy" @testSuiteOpen="testSuiteOpen"
                />
...
export const ProjectPage = Template.bind({});
ProjectPage.args = {
  api: false,
  notLatestData: false,
  user: {
