<template>
  <v-card elevation="4" max-width="1800">
    <v-card-title class="justify-center">
      {{
        $t(
          "organisms.common.notation_based_specified_commodity_transaction_law.title"
        )
      }}
    </v-card-title>
    <v-card-text>
      <div
        v-for="(content, index) in $t(
          'organisms.common.notation_based_specified_commodity_transaction_law.contents'
        )"
        :key="index"
      >
